...
public class ContactService {
    ...
    public PersonContact createPerson(String ownerUserId, String fullName,
                                      List<String> phoneInputs, List<String> emailInputs)
    ...
    public OrganizationContact createOrganization(String ownerUserId, String orgName,
                                                  List<String> phoneInputs, List<String> emailInputs)
            throws ValidationException, DuplicateContactException {
        validateOwner(ownerUserId);
